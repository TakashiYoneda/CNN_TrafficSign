...
* Training set after Augmentation (data size: 83,000)
...
* I tried deeper network and learnded with more augmented data (134,000 training images), but the new traffic sign recognition was too bad.  I think that is because of shortage of learning (50 epochs).  I only have modest CPU pc, so I couldnot elaborate on this.  After getting GPU, I will back to this issue to confirm.
...
https://github.com/TakashiYoneda/CNN_TrafficSign/blob/master/Traffic_Sign_Classifier_001_YUV_norm(0-1)_AdHist_Augment_NewTest_Low.ipynb
